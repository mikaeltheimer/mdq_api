...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'motsdits_story', 'photo',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['motsdits.Photo'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.photo'
        db.delete_column(u'motsdits_story', 'photo_id')
    ...
    models = {
        u'accounts.mdquser': {
            ...
            'validation_code': ('django.db.models.fields.CharField', [], {'default': "'a477fb445f7646a981e7cbdf6f91429b'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'motsdits.action': {
        ...
        u'motsdits.story': {
            ...
            'photo': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['motsdits.Photo']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'score': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'})
        },
