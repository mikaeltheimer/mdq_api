...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.display_name'
        db.add_column(u'motsdits_item', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.display_name'
        db.delete_column(u'motsdits_item', 'display_name')
    ...
    models = {
        u'accounts.mdquser': {
            ...
            'validation_code': ('django.db.models.fields.CharField', [], {'default': "'e22b369fb0994abebf242f4b701280a9'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'motsdits.action': {
