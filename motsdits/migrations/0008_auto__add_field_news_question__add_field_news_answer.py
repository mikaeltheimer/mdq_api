...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.question'
        db.add_column(u'motsdits_news', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='news_about', null=True, to=orm['motsdits.Question']),
                      keep_default=False)

        # Adding field 'News.answer'
        db.add_column(u'motsdits_news', 'answer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='news_about', null=True, to=orm['motsdits.Answer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.question'
        db.delete_column(u'motsdits_news', 'question_id')

        # Deleting field 'News.answer'
        db.delete_column(u'motsdits_news', 'answer_id')
    ...
    models = {
        u'accounts.mdquser': {
            ...
            'validation_code': ('django.db.models.fields.CharField', [], {'default': "'dffd122d0860488e93016fc5c7dc77d4'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'motsdits.action': {
