...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Action', fields ['verb']
        db.create_unique(u'motsdits_action', ['verb'])


    def backwards(self, orm):
        # Removing unique constraint on 'Action', fields ['verb']
        db.delete_unique(u'motsdits_action', ['verb'])
