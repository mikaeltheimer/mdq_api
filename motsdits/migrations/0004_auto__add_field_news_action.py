...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.action'
        db.add_column(u'motsdits_news', 'action',
                      self.gf('django.db.models.fields.CharField')(default='motdit-created', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.action'
        db.delete_column(u'motsdits_news', 'action')
