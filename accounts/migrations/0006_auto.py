...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field liked_stories on 'MDQUser'
        m2m_table_name = db.shorten_name(u'accounts_mdquser_liked_stories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mdquser', models.ForeignKey(orm[u'accounts.mdquser'], null=False)),
            ('story', models.ForeignKey(orm[u'motsdits.story'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mdquser_id', 'story_id'])


    def backwards(self, orm):
        # Removing M2M table for field liked_stories on 'MDQUser'
        db.delete_table(db.shorten_name(u'accounts_mdquser_liked_stories'))
