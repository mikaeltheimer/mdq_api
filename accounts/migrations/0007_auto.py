...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field following on 'MDQUser'
        m2m_table_name = db.shorten_name(u'accounts_mdquser_following')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_mdquser', models.ForeignKey(orm[u'accounts.mdquser'], null=False)),
            ('to_mdquser', models.ForeignKey(orm[u'accounts.mdquser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_mdquser_id', 'to_mdquser_id'])


    def backwards(self, orm):
        # Removing M2M table for field following on 'MDQUser'
        db.delete_table(db.shorten_name(u'accounts_mdquser_following'))
