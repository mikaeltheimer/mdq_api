...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field likes on 'MDQUser'
        m2m_table_name = db.shorten_name(u'accounts_mdquser_likes')
        ...
        db.create_unique(m2m_table_name, ['mdquser_id', 'motdit_id'])

        # Adding M2M table for field favourites on 'MDQUser'
        m2m_table_name = db.shorten_name(u'accounts_mdquser_favourites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mdquser', models.ForeignKey(orm[u'accounts.mdquser'], null=False)),
            ('motdit', models.ForeignKey(orm[u'motsdits.motdit'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field likes on 'MDQUser'
        db.delete_table(db.shorten_name(u'accounts_mdquser_likes'))

        # Removing M2M table for field favourites on 'MDQUser'
        db.delete_table(db.shorten_name(u'accounts_mdquser_favourites'))
