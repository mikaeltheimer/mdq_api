...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MDQUser.avatar'
        db.add_column(u'accounts_mdquser', 'avatar',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MDQUser.avatar'
        db.delete_column(u'accounts_mdquser', 'avatar')
    ...
    models = {
        u'accounts.mdquser': {
            ...
            'validation_code': ('django.db.models.fields.CharField', [], {'default': "'6d9aa677dd7045488aba5b97f712ff8a'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'motsdits.action': {
