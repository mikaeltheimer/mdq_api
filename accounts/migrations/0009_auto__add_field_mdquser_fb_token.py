...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MDQUser.fb_token'
        db.add_column(u'accounts_mdquser', 'fb_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MDQUser.fb_token'
        db.delete_column(u'accounts_mdquser', 'fb_token')
    ...
    models = {
        u'accounts.mdquser': {
            ...
            'validation_code': ('django.db.models.fields.CharField', [], {'default': "'4714f344e9f7406a98e51671c88e1ef8'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'motsdits.action': {
